...
class Sensor extends React.Component {
  ...
  constructor(props) {
    ...
    props.session.call("com.herokuapp.crossbar-pedro.sensor.measurement", [props.scene._id.$oid]).then(this.set_measurement);
    props.session.subscribe("com.herokuapp.crossbar-pedro.sensor.measurement.new." + props.scene._id.$oid, this.set_measurement);
  }
